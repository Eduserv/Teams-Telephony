...
$NR += New-CsVoiceNormalizationRule -Name "UK-Fareham-Local" -Parent $DPParent -Pattern '^\+440?1329(([2-8]\d\d|9[0-8]\d|99[0-8])\d{3})$' -Translation '+441329$1' -InMemory -Description "Local number normalization for Fareham, United Kingdom"
...
Set-CsOnlinePSTNUsage -Identity global -Usage @{Add="UK-Farehamn-Local"} -WarningAction:SilentlyContinue | Out-Null
